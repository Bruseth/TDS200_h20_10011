import { IonList, IonItem, IonInput, IonButton, IonToast, IonCard, IonContent, IonToolbar, IonButtons, IonHeader, IonIcon, IonAvatar, IonModal, IonFabButton } from "@ionic/react";
...
const AvatarStyled = styled(IonAvatar)`
height: 100px;
width: 100px;
align-items: center;
`;
