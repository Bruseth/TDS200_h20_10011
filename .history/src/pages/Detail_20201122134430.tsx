...
import {
  ...
  IonLabel,
  IonButtons,
  IonBackButton, IonButton, IonIcon, IonActionSheet, IonTextarea, IonSlides, IonSlide, IonAlert
} from "@ionic/react";
...
const Detail = (props: any) => {
  ...
  const { loading, data } = useS<ICommentList>(GET_COMMENTS, {
    variables: {
      post_id: post?.id
    },
    ...
    <IonPage>
      ...
      <IonContentStyled>
        ...
        <IonAlert
          ...
          cssClass='my-custom-class'
          header={'Advarsel'}
          message={'Er du sikker på at du vil slette posten?'}
          buttons={
            [{
              text: 'Slett',
              role: 'destructive',
