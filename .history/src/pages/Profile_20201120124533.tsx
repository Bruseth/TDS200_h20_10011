...
import { IonPage, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonContent, IonCard, IonList, IonItem, IonInput, IonButton, IonProgressBar, IonApp, IonListHeader, IonAvatar } from "@ionic/react";
...
const Profile = () => {
  ...
  return (
    ...
    <IonContent fullscreen>
      ...
      <IonListHeader>Chip Avatar</ion-list-header>
