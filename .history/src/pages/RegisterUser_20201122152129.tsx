...
const RegisterUser: React.FC<any> = ({ isOpen, onClick }) => {
  const [showModal, setShowModal] = useState({isOpen: false});  let history = useHistory();
  ...
  return (
    <IonModal isOpen={showModal.isOpen}>
      <IonPage>
        <IonHeader>
          <IonToolbar>
        ...
        <IonContentStyled>
          <CenterContainer>
            ...
            <IonButton onClick={registerUser}>
              ...
              <IonButton onClick={(onClick)}>Lukk</IonButton>
          </CenterContainer>
