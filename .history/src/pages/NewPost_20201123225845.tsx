...
//funksjonalitet for slides
  ...
  //Lagt til en lopp som skulle lese hvert bildetekst slik at det ble riktig tolket i /public mappen
  ...
  return (
    <IonPage>
      ...
      <IonContent>
        <IonCard>
          {/**Intensjonen er at brukeren skal se alle bildene som blir tatt før de blir lastet opp. Dette blir fremvist i en slide */}
