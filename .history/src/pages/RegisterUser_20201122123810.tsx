import { IonPage, IonList, IonItem, IonInput, IonButton, IonToast, IonCard, IonContent, useIonViewWillEnter, IonToolbar, IonButtons, IonBackButton, IonHeader, IonIcon, IonAvatar, IonThumbnail } from "@ionic/react";
...
const RegisterUser = () => {
  ...
  const registerUser = async () => {
    ...
    try {
      await auth.register(emailAddress, password, { display_name: userName, avatar_url: filename ? filename : "default-avatar.jpg" })
