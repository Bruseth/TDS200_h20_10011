...
import { cameraOutline, person-add-outline, personOutline } from "ionicons/icons";
    ...
    <IonPage>
      <IonContentStyled>
        <CenterContainer>
          ...
          <IonButton aria-label="delete" disabled color="primary" onClick={() => setRegisterModal({ isOpen: true })}>
            <IonIcon icon={} />
          </IonButton>
        </CenterContainer>
        <RegisterModal 
