...
const ProfileGalleri = (props: any) => {
  ...
  const { loading, data } = useQuery<IImagesList>(GET_COMMENTS, {
    variables: {
      post_id: post?.id
    },
    fetchPolicy: "no-cache"
                ...
                <>
                  <IonSlide>
                    ...
                    <IonCard key={i}>
                      ...
                      <img src={`https://backend-ck80jrpa.nhost.app/storage/o/public/${post.image_filename}`} />
