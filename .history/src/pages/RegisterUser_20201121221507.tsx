import { IonPage, IonList, IonItem, IonInput, IonButton, IonToast, IonCard, IonContent, useIonViewWillEnter, IonToolbar, IonButtons, IonBackButton, IonHeader, IonIcon, IonAvatar } from "@ionic/react";
    ...
    <IonPage>
      ...
      <IonContentStyled>
        <CenterContainer>
          ...
          <IonAvatar>
           { 
           <img src={photo?.dataUrl ? dataUrl: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fverdiskapingsfondet.no%2Fom-oss%2Fattachment%2Fdefault-user-image%2F&psig=AOvVaw1_lvUJ01otxmxOY26LKQEl&ust=1606079477068000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCOjNoLjGlO0CFQAAAAAdAAAAABAD"}  /> }
          </IonAvatar>
          <LoginCard>
